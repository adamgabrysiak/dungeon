...
class Application(Frame):
	...
	def directions_control(self):
		...
		self.north_button = Button(self.directions_control_window, text = "North", command = self.location.move_north)
		self.south_button = Button(self.directions_control_window, text = "South")
		self.west_button = Button(self.directions_control_window, text = "West")
		self.east_button = Button(self.directions_control_window, text = "East")
...
class Location(object):
	def __init__(self):
		...
		self.available_directions = [self.north, self.south, self.west, self.east]
	...
	def forest(self):
		...
		self.north = self.forest_grid[self.current_coordinates_x][self.current_coordinates_y + 1]
		self.south = self.forest_grid[self.current_coordinates_x][self.current_coordinates_y - 1]
		self.west = self.forest_grid[self.current_coordinates_x - 1][self.current_coordinates_y]
		self.east = self.forest_grid[self.current_coordinates_x + 1][self.current_coordinates_y]
